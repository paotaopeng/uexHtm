...
import com.wisemen.taskrunner.download.db.DownloadRequest;
...
public class DownloadInfo implements Comparable<DownloadInfo> {
    ...
    public static ContentValues buildContentValues(DownloadInfo downloadInfo) {
        ...
        downloadRequest.netStatusRelated = request.isIndependentOfNetStatus();
        ...
        try {
            if (requestData != null) {
                ...
                if (request != null) {
                    ...
                    request.setIndependentOfNetStatus(downloadRequest.netStatusRelated);
